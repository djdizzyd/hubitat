...
metadata {
    definition (name: "Zooz Zen26 Central Scene Switch", namespace: "djdizzyd", author: "Bryan Copeland", importUrl: "") {
        ...
        fingerprint mfr:"027A", prod:"A000", deviceId:"A001", inClusters:"0x5E,0x25,0x85,0x8E,0x59,0x55,0x86,0x72,0x5A,0x73,0x70,0x5B,0x6C,0x9F,0x7A", deviceJoinName: "Zooz Zen26 Switch" //US
...
@Field static Map configParams = [
        ...
        10: [input: [name: "configParam10", type: "enum", title: "Enable/Disable Scene Control", defaultValue: 0, options:[0:"Scene control disabled",1:"scene control enabled"]],parameterSize:1],
