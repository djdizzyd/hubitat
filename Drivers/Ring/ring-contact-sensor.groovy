...
metadata {
    ...
    definition (name: "Ring Alarm Contact Sensor", namespace: "djdizzyd", author: "Bryan Copeland", importUrl: "https://raw.githubusercontent.com/djdizzyd/hubitat/master/Drivers/Ring/ring-contact-sensor.groovy") {
        capability "Actuator"
        capability "Sensor"
        ...
        fingerprint  mfr:"0346", prod:"0201", deviceId:"0201", inClusters:"0x5E,0x55,0x9F,0x85,0x59,0x80,0x70,0x5A,0x72,0x71,0x73,0x6C,0x86,0x84,0x7A", deviceJoinName: "Ring Alarm Contact Sensor"
    }
    preferences {
