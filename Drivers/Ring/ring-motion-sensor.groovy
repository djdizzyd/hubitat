...
metadata {
    ...
    definition (name: "Ring Alarm Motion Sensor", namespace: "djdizzyd", author: "Bryan Copeland") {
        ...
        fingerprint mfr:"0346", prod:"0301", deviceId:"0201", inClusters:"0x5E,0x55,0x9F,0x85,0x59,0x80,0x70,0x5A,0x72,0x71,0x73,0x6C,0x86,0x84,0x7A", deviceJoinName: "Ring Alarm Motion Sensor"
    }
    preferences {
...
@Field static Map configParams = [
        1: [input: [name: "configParam1", type: "number", title: "Unsolicited Report Time (heartbeat)", description: "seconds", range: "255..4200", defaultValue: 255], parameterSize: 2],
        2: [input: [name: "configParam2", type: "number", title: "Dwell Time", description: "minutes", range: "1..9", defaultValue: 9], parameterSize: 1],
        3: [input: [name: "configParam3", type: "enum", title: "Pet Immunity", description: "", defaultValue: 2, options: [0: "No pet immunity", 1: "15kg (33lb)", 2:"25kg (55lb)"]], parameterSize: 1]
]
