...
metadata {
    ...
    definition (name: "Ring Alarm Range Extender", namespace: "djdizzyd", author: "Bryan Copeland") {
        ...
        fingerprint mfr:"0346", prod:"0401", deviceId:"0201", inClusters:"0x5E,0x85,0x59,0x55,0x86,0x72,0x5A,0x73,0x9F,0x80,0x71,0x6C,0x70,0x7A", deviceJoinName: "Ring Alarm Range Extender"
    }
    preferences {
